...
public class Main {
    public static void main (String[] args) {
        ...
        System.out.format("%-15s%-10s%-10s%-15s%-25s%-25s%-20s%-15s%-15s%n", sedan2.getVehicleId(), sedan2.getCarBrand(), sedan2.getColor(), sedan2.getFuelType(), sedan2.isAutomatic(), sedan2.getModelId(), sedan2.getPassLim(), sedan2.getMileageLim(), sedan2.isCanOffRoad());
        System.out.format("%-15s%-10s%-10s%-15s%-25s%-25s%-20s%-15s%-15s%n", sedan3.getVehicleId(), sedan3.getCarBrand(), sedan3.getColor(), sedan3.getFuelType(), sedan3.isAutomatic(), sedan3.getModelId(), sedan3.getPassLim(), sedan3.getMileageLim(), sedan3.isCanOffRoad());
